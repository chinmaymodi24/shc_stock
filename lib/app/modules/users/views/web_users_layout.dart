...
const int _kMailFlex   = 22;
const int _kPhonFlex   = 14;
const int _kRoleFlex   = 15;
const int _kLoginFlex  = 18;
const int _kStatFlex   = 10;
const int _kActFlex    = 8;

// ─────────────────────────────────────────────────────────────────────────────
// Main Widget
// ─────────────────────────────────────────────────────────────────────────────
class WebUsersLayout extends StatefulWidget {
  const WebUsersLayout({super.key});
  @override
  State<WebUsersLayout> createState() => _WebUsersLayoutState();
}

class _WebUsersLayoutState extends State<WebUsersLayout> {
        ...
        Expanded(child: Column(children: [
          ...
          Expanded(child: Obx(() {
            ...
            final filtered = all.where((u) {
              ...
              final matchRole   = _filterRole == 'All Roles' || u.role.label == _filterRole;
              final matchStatus = _filterStatus == 'All Status' ||
                  ...
                  Row(
                    ...
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('Manage employees and their access roles.',
                          style: TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(child: _StatCard(
                          ...
                          spark: const [0.4, 0.55, 0.5, 0.65, 0.6, 0.75, 0.7],
                        )),
                        ...
                        Expanded(child: _StatCard(
                          ...
                          spark: const [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
                        )),
                        const SizedBox(width: 16),
                        Expanded(child: _StatCard(
                          ...
                          trend: '-5.0%', trendUp: false,
                          spark: const [0.6, 0.55, 0.5, 0.45, 0.4, 0.38, 0.35],
                        )),
                      ],
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Expanded(child: Container(
                        ...
                        child: Column(children: [
                          ...
                          _Toolbar(
                            ...
                            onSearch: (v) => setState(() {
                              _searchQuery = v; _currentPage = 1;
                            }),
                            onRoleChanged: (v) => setState(() {
                              _filterRole = v; _currentPage = 1;
                            }),
                            onStatusChanged: (v) => setState(() {
                              _filterStatus = v; _currentPage = 1;
                            }),
                          ),
                          ...
                          if (pageItems.isEmpty)
                            Padding(
                              ...
                              child: Center(child: Column(
                                ...
                                Text('No employees found', style: TextStyle(
                                  fontSize: 14, color: colors.textHint,
                                  fontFamily: 'Poppins')),
                              ])),
                            )
                          else
                            ...pageItems.asMap().entries.map((e) => _UserRow(
                              user: e.value,
                      ...
                      SizedBox(width: 272, child: Column(children: [
                        ...
                        _QuickActionsCard(colors: colors,
                            onAddUser: () => Get.toNamed(AppRoutes.addEmployee)),
                      ])),
                    ],
                  ),
                ],
...
class _DialogField extends StatelessWidget {
  ...
  const _DialogField({
    ...
    required this.hint, required this.colors,
  });
    ...
    return Padding(
      ...
      child: Row(children: [
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(
                fontSize: 13, color: colors.textHint, fontFamily: 'Poppins'),
              prefixIcon: Icon(
                Icons.search_rounded, color: colors.textHint, size: 17),
              isDense: true,
        ...
        OutlinedButton.icon(
          ...
          label: Text('Export', style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(flex: _kCodeFlex, child: Text('User Code', style: _s)),
        Expanded(flex: _kNameFlex, child: Text('Name', style: _s)),
        Expanded(flex: _kMailFlex, child: Text('Email', style: _s)),
        Expanded(flex: _kPhonFlex, child: Text('Phone', style: _s)),
        Expanded(flex: _kRoleFlex, child: Text('Role', style: _s)),
        Expanded(flex: _kLoginFlex, child: Text('Last Login', style: _s)),
...
class _UserRow extends StatefulWidget {
  ...
  final bool isLast;
  const _UserRow({
    required this.user, required this.displayIndex,
    required this.colors, required this.isLast,
  });
        ...
        child: Padding(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Container(
              ...
              child: Center(child: Text('${widget.displayIndex}',
            ...
            // User code
            Expanded(flex: _kCodeFlex, child: Text(u.code,
              style: const TextStyle(
                fontSize: 12.5, fontWeight: FontWeight.w600,
            ...
            Expanded(flex: _kNameFlex, child: Row(children: [
              Container(
                ...
                child: Center(child: Text(u.initials, style: TextStyle(
                  ...
                  color: u.badgeColor, fontFamily: 'Poppins'))),
              ),
              const SizedBox(width: 8),
            ...
            // Email
            Expanded(flex: _kMailFlex, child: Text(u.email,
              style: TextStyle(
            ...
            // Phone
            Expanded(flex: _kPhonFlex, child: Text(u.phone,
              style: TextStyle(
                fontSize: 12.5, color: c.textSecondary,
                fontFamily: 'Poppins'))),

            // Role badge
            Expanded(flex: _kRoleFlex, child: Row(children: [
              Container(
                padding: const EdgeInsets.symmetric(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text(u.role.label, style: TextStyle(
                    fontSize: 12, fontWeight: FontWeight.w600,
                    color: u.role.color, fontFamily: 'Poppins')),
                ]),
              ),
            ])),

            // Last Login
            Expanded(flex: _kLoginFlex, child: Text(u.lastLogin,
              style: TextStyle(
...
class _Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      child: Row(children: [
        Text('Showing $startDisplay to $endDisplay of $total employees',
          style: TextStyle(
        ...
        const SizedBox(width: 16),
        _PBtn(icon: Icons.first_page_rounded,
          enabled: currentPage > 1, colors: colors,
          onTap: () => onPageChanged(1)),
        const SizedBox(width: 4),
        _PBtn(icon: Icons.chevron_left_rounded,
          enabled: currentPage > 1, colors: colors,
          onTap: () => onPageChanged(currentPage - 1)),
        const SizedBox(width: 6),
        ..._buildPageNums(),
        const SizedBox(width: 6),
        _PBtn(icon: Icons.chevron_right_rounded,
          enabled: currentPage < totalPages, colors: colors,
          onTap: () => onPageChanged(currentPage + 1)),
        const SizedBox(width: 4),
        _PBtn(icon: Icons.last_page_rounded,
          enabled: currentPage < totalPages, colors: colors,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          child: Text('Employee Summary', style: TextStyle(
            fontSize: 14, fontWeight: FontWeight.w700,
            color: colors.textPrimary, fontFamily: 'Poppins')),
        ),
        Divider(height: 1, color: colors.divider),
        _SumRow(label: 'Total Employees',    value: '${c.totalUsers}',    colors: colors),
        _SumRow(label: 'Active Employees',   value: '${c.activeUsers}',   colors: colors, valueColor: const Color(0xFF22C55E)),
        _SumRow(label: 'Inactive Employees', value: '${c.inactiveUsers}', colors: colors, valueColor: const Color(0xFFEF4444)),
        _SumRow(label: 'Admins',         value: '${c.adminCount}',    colors: colors, valueColor: AppColors.primaryOrange, isLast: true),
      ]),
    );
  }
}
...
class _SumRow extends StatelessWidget {
  ...
  const _SumRow({
    ...
    required this.colors, this.valueColor, this.isLast = false,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          padding: const EdgeInsets.fromLTRB(16, 14, 16, 10),
          child: Text('Role Breakdown', style: TextStyle(
            fontSize: 14, fontWeight: FontWeight.w700,
            color: colors.textPrimary, fontFamily: 'Poppins')),
        ),
        Divider(height: 1, color: colors.divider),
          ...
          return Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                const SizedBox(width: 8),
                Expanded(child: Text(role.label, style: TextStyle(
                  fontSize: 12.5, color: colors.textSecondary,
                  fontFamily: 'Poppins'))),
...
class _QAction extends StatefulWidget {
  ...
  const _QAction({
    ...
    required this.colors, required this.onTap, this.isLast = false,
  });
