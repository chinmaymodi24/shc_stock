                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _Label('DESPATCH THROUGH', colors),
                      const SizedBox(height: 4),
                      _Value(
                        order.despatchThrough.isEmpty
                            ? '—'
                            : order.despatchThrough,
                        colors,
                      ),
                      const SizedBox(height: 16),
                      _PairRow(
                      ...
                      _PairRow(
                        ...
                        order.vehicleNo,
                        'FREIGHT',
                        order.freight > 0 ? _fmtAmt(order.freight) : '—',
                        colors,
                      ),
                      const SizedBox(height: 16),
                      _PairRow(
                          ...
                          (item) => Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 3),
                                Text(
                                  'HSN ${item.hsn.isEmpty ? '—' : item.hsn} · Grade ${item.grade.isEmpty ? '-' : item.grade} · '
                                  'Density ${item.density.isEmpty ? '-' : item.density} · ${item.qty.toStringAsFixed(0)} ${item.unit} · '
